...
var startNoteSelector = document.getElementById('start-note');
var octaveSelector = document.getElementById('octave');
var durationSelector = document.getElementById('duration');
var playButton = document.getElementById('playButton');
var addButton = document.getElementById('addButton');
var breakButton = document.getElementById('breakButton');
var notesToPlay = document.getElementById('notes-to-play');
var undoButton = document.getElementById('undoButton');
var deleteButton = document.getElementById('deleteButton');
var playAllButton = document.getElementById('play-all-button');
var selectedStartNote = 'C';
var selectedOctave = 1;
var selectedDuration = 400;
var notesToPlayArr = [];
var soundsArr = [];
var isPlaying = false;
var app = {
  ...
  playNote: function playNote() {
    playButton.addEventListener('click', function () {
      if (!isPlaying) {
        isPlaying = true;
        var selectedNote = selectedStartNote + selectedOctave;
        soundEngine.playOne(selectedNote);
      }
    });
  },
  playAllNotes: function playAllNotes() {
  ...
  addNote: function addNote() {
    addButton.addEventListener('click', function () {
      ...
      notesToPlayArr = soundsArr.map(function (s) {
        return s.noteName;
      });
  ...
  setupDuration: function setupDuration() {
    for (var i = 400; i <= 2400; i += 400) {
      var durationTime = this.createElement('option', i);
...
var mySound = /*#__PURE__*/function () {
  function mySound(noteName, isBreak, duration) {
    _classCallCheck(this, mySound);
  ...
  _createClass(mySound, [{
    key: "midify",
    value: function midify() {
      if (this.isBreak) {
        return (0, _tonal.note)('C1').midi;
      } else {
        return (0, _tonal.note)(this.noteName).midi;
      }
    }
  }, {
    key: "play",
...
var soundEngine = {
  ...
  play: function play(allSounds) {
    var i = 0;
    var length = allSounds.length;
  ...
  playOne: function playOne(selectedNote) {
    sound.volume(0.5);
    var midiNumber = this.noteToMidi(selectedNote);
  ...
  noteToMidi: function noteToMidi(noteToConvert) {
    if (noteToConvert !== 'break') {
      return (0, _tonal.note)(noteToConvert).midi;
    }
  }
};
app.init();
},{"howler":"node_modules/howler/dist/howler.js","@tonaljs/tonal":"node_modules/@tonaljs/tonal/dist/index.es.js"}],"../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
//# sourceMappingURL=/type_your_music.e31bb0bc.js.map